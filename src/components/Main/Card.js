...
function Card({ data, avatar, imageProfile }) {
  return (
    <article className="autor">
      <div className="autor__info-project">
        <p className="autor__info-project--subtitle">
          Personal Project Card
        </p>
        <h2 className="autor__info-project--title">
          {data.name || "Gestor de Proyectos"}
        </h2>
        <p className="autor__info-project--slogan">
          {data.slogan || "Emprende tus proyectos sin límites"}
        </p>
        <p className="autor__info-project--desc">
          {data.desc ||
        ...
        <div className="autor__info-project--technologies">
          <p className="autor__info-project--technologies--text">
            {data.technologies || "React JS, SASS"}
          </p>
        </div>
        <div className="autor__info-project--icons">
          <a
      ...
      <div className="autor__info-autor">
        <Profile
          imageProfile={imageProfile}
          avatar={avatar}
          className={"autor__info-autor--image"}
        />
        <p className="autor__info-autor--job">
          {data.job || "Full Stack Developer"}
        </p>
        <p className="autor__info-autor--name">
